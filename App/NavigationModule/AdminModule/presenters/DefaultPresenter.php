...
class DefaultPresenter extends \Venne\Developer\Presenter\AdminPresenter {
	...
	{
		$form = new \App\NavigationModule\NavigationForm($this, $name);
	...
	{
		$form = new \App\NavigationModule\NavigationForm($this, $name, $this->context->services->navigation->repository->find($this->getParam("id")));
