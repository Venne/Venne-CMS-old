...
class DefaultPresenter extends \Venne\Developer\Presenter\InstallationPresenter
{
	...
	public function startup()
	{
		 ...
		 * Writable
		 */
		$paths = array($this->getContext()->params["wwwDir"] . "/public/", $this->getContext()->params["wwwDir"] . "/themes/", $this->getContext()->params["appDir"] . "/config.neon", $this->getContext()->params["flagsDir"]);
	...
	{
		$form = new \App\SystemModule\SystemDatabaseForm($this, $name, "common", false, true);
		$form->setSuccessLink("this");
