...
class Service extends \Venne\Developer\Service\BaseService {
	...
	public function __construct(\Nette\DI\Container $context, $moduleName)
	{
		$this->context = $context;
		parent::__construct($moduleName);
		$this->dir = $this->context->params["wwwDir"] . "/modules/repository";
	}
	...
	{
		umask(0000);
		@mkdir(TEMP_DIR . "/repository", 0777, true);
