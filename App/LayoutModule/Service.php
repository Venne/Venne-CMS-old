...
class Service extends Venne\Developer\Service\DoctrineService {
	...
	/** @var string */
	public $entityNamespace = "\\App\\LayoutModule\\";
	...
	{
		$nav = new \App\NavigationModule\NavigationEntity("Layouts");
	...
	public function detectLayout()
	{
		...
		$query = $this->getEntityManager()->createQuery('
					SELECT u FROM \App\LayoutModule\LayoutEntity u ORDER BY u.regex DESC
				');
