...
implements
	Venne\CMS\Developer\IRouteModule,
	Venne\CMS\Developer\ISitemapModule	
{
	...
	public function getSitemap($priority)
	{
		...
		$pages = $this->getRepository()->findByWebsite($this->container->website->getCurrentWebsite($this->container->httpRequest)->id);
