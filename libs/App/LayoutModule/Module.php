...
class Module extends \Venne\Developer\Module\AutoModule {
	...
	public function setServices(\Venne\Application\Container $container)
	{
		$container->services->addService("layout", function() use ($container) {
					return new \App\LayoutModule\Service($container, "layout", $container->doctrineContainer->entityManager);
				}
		);
	}
	...
	public function setHooks(\Venne\Application\Container $container, \App\HookModule\Manager $manager)
	{
		...
		$manager->addHookExtension(\App\HookModule\Manager::EXTENSION_CONTENT, new LayoutContentExtension($container->services->layout));
	}
